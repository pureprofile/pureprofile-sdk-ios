Pod::Spec.new do |s|  
    ...
    s.license           = { :type => 'Commercial', :file => 'PureprofileSDK/LICENSE' }
    s.platform          = :ios
    s.source            = { :http => 'https://devtools.pureprofile.com/surveys/ios/releases/PureprofileSDK.zip' }
    s.description       = <<-DESC
...
DESC
    ...
    s.vendored_frameworks = 'PureprofileSDK/PureprofileSDK.framework'
end 
